...
function Board({ squares, xIsNext, onPlay, resetBoard }: boardProps) {
  ...
  return (
    <div className="grid grid-rows-3 grid-cols-3 gap-4 p-4 max-w-sm mx-auto bg-white rounded-xl shadow-lg items-center justify-center">
      <h1 className="text-2xl sm:text-4xl col-span-3 text-center font-bold">Tic-Tac-Toe</h1>
